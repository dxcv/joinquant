...
if __name__ == '__main__':
    ...
    pos_df_all = pd.read_csv('e:/fof/cgo/' + 'indus_pos_df_all.csv', encoding='gbk')\
        ...
        .rename(columns={'cyb': '399006.SZ', 'hs300': '000300.SH', 'zz500': '000905.SH', 'sz50': '000016.SH'})\
    ...
    for pos_method in pos_method_lst:
        ...
        for j in range(len(index_code_lst)):
            ...
            pos_df = index_hq_dict[index_code].merge(pos_df, on=['trade_date']).sort_values(['trade_date']) \
