...
if __name__ == '__main__':
    ...
    if today in calen:
        ...
        for i in range(len(index_code_lst)):
            ...
            SZ50_stocks_list = stock_code_lst(code)
            ...
            df_50_1.to_csv(fold + 'df_50_1_' + index_name + '.csv', encoding='gbk')
            # df_50_1 = pd.read_csv(fold + 'df_50_1_' + index_name + '.csv', encoding='gbk', index_col=0)
