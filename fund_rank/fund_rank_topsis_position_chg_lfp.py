...
if __name__ == '__main__':
    ...
    for i in underlying_asset_type_id:
        ...
        if i != 402003:
            tmp = tmp.query("annror_36 > %s" % annror_36)
            ...
            tmp = tmp.query("annror_36 > %s" % annror_36_402003)
    ...
    fund_rank_r.to_csv('G:/lfp/result/fund_rank_position_chg_lfp.csv', encoding='gbk')
